...
const Privacy = () => {
  return (
    <div className=" min-h-screen md:px-32 px-8">
      <h1 className=" text-3xl text-center mb-9">PRIVACY POLICY</h1>
      <div className="leading-8 text-lg">
        <i>Effective date: 2023-03-01</i>
        <p>1. Introduction</p>
        Welcome to <span className=" font-bold">PayWS Ltd.</span>
        <span className=" font-bold">PayWS Ltd</span> (“us”, “we”, or “our”)
        operates <span className=" font-bold"> aftawallet.com</span>{" "}
        (hereinafter referred to as
        <span className=" font-bold"> “Service”</span>).
        <p>
          Our Privacy Policy governs your visit to aftawallet.com, and explains
          ...
          same meanings as in our Terms and Conditions. Our Terms and Conditions
          (<span className=" font-bold"> “Terms”</span>) govern all use of our
          Service and together with the Privacy Policy constitutes your
          agreement with us (<span className=" font-bold"> “agreement”</span>).
        </p>
        <p className=" font-bold"> 2. Definitions</p>
        <p>
          <span className=" font-bold"> SERVICE</span> means the{" "}
          <span className=" font-bold">aftawallet.com</span> website operated by
          PayWS Ltd.
        </p>
        <p>
        ...
        <p className=" font-bold">DATA SUBJECT</p> is any living individual who
        is the subject of Personal Data.
        <p className=" font-bold">THE USER</p> is the individual using our
        ...
        0.3. Phone number 0.4. Address, Country, State, Province, ZIP/Postal
        code, City
        <br />
        0.5. Cookies and Usage Data We may use your
        <br />
        ...
        <span className=" font-bold">(“Usage Data”)</span>.<br /> This Usage
        ...
        data.
        <p className=" font-bold">Location Data</p>
        We may use and store information about your location if you give us
        permission to do so{" "}
        <span className=" font-bold">(“Location Data”)</span>. We use this data
        to provide features of our Service, to improve and customize our
        Service.
        <br /> You can enable or disable location services when you use our
        Service at any time by way of your device settings.
        <br />
        <p className=" font-bold">Tracking Cookies Data</p>
        We use cookies and similar tracking technologies to track the activity
        on our Service and we hold certain information. <br />
        ...
        <br />
        Examples of Cookies we use: 0.1. <br />
        <span className=" font-bold">Session Cookies</span>: We use Session
        Cookies to operate our Service. 0.2. <br />
        ...
        <br />
        0.3.<span className=" font-bold"> Security Cookies</span>: We use
        Security Cookies for security purposes. 0.4. <br />
        ...
        <br />
        <p className=" font-bold">Other Data</p>
        ...
        (work, mobile), social security (or other taxpayer identification)
