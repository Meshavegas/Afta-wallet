  ...
  return (
    <div className=" min-h-screen md:px-32 px-8">
      ...
      <div className="leading-8 text-lg">
        ...
        PayWS Ltd uses the collected data for various purposes: <br />
        ...
        <br /> If you are located outside Republic of Cameroon and choose to
        provide information to us, please note that we transfer the data,
        including Personal Data, to Republic of Cameroon and process it there.
        <br /> Your consent to this Privacy Policy followed by your submission
        of such information represents your agreement to that transfer.
        <br /> PayWS Ltd will take all the steps reasonably necessary to ensure
        ...
        <p className=" font-bold">0.1. Disclosure for Law Enforcement.</p>
        ...
        <br />
        <p className=" font-bold">0.2. Business Transaction.</p>
        If we or our subsidiaries are involved in a merger, acquisition or asset
        sale, your Personal Data may be transferred. <br />
        ...
        or limit the use of your Personal Data. <br />
        ...
        personal information; Please note that we may ask you to verify your
        identity before responding to such requests. Please note, we may not
        able to provide Service without some necessary data. You have the right
        to complain to a Data Protection Authority about our collection and use
        ...
        please send your request(s) by email: support@aftawallet.com.
        <br />
        ...
        <p className=" font-bold">13. Service Providers</p>
        ...
        <p className=" font-bold">14. Analytics</p>
        We may use third-party Service Providers to monitor and analyze the use
        of our Service.
        <p className=" font-bold">15. CI/CD tools</p>
        We may use third-party Service Providers to automate the development
        process of our Service.
        <p className=" font-bold">16. Behavioral Remarketing</p>
        ...
        our Service.
        <p className=" font-bold">17. Payments</p>
        ...
        <br />
        <span className=" font-bold">18. Links to Other Sites</span>
        ...
        <br />
        <span className=" font-bold">19. Children’s Privacy</span>
        ...
        <br />
        <span className=" font-bold">20. Changes to This Privacy Policy</span>
        ...
        posted on this page.
        <p className=" font-bold">21. Contact Us</p>
        If you have any questions about this Privacy Policy, please contact us
        by email:<span className=" font-bold"> support@aftawallet.com.</span>
      </div>
    </div>
  );
};
