  ...
  return (
    <div className="min-h-screen md:px-32 px-8 my-6">
      ...
      <div className="leading-10 text-lg">
        ...
        <p>
          There are only two things you will be charged for; transaction fees
          and exchange fees. Some are even free but we make sure in everything
          we remain transparent because if we can't be accountable to you, then
          we have no business keeping your money.
        </p>
        <p>
          3b. <b>Cheat codes</b>
        </p>
        <p>
          To show some love, we can have some hidden cheat codes that exempt you
          from either exchange fees or transaction fees or both. You can earn
          them upon completing certain actions that include but are not limited
          to: (i)Making at least 10 transactions worth over $20 or equivalent
          each. (ii) Sharing the link with those in your network who will
          signup. (iii) Using the service in at least 3 countries.
        </p>
        <p>
        ...
        <p>
          We issue refunds for Contracts within <b>7 days</b>
        ...
        <p>
          Content found on or through this Service are the property of PayWS Ltd
        ...
        <p>
          ...
          account and PIN, including but not limited to the restriction of
        ...
        <p>
          ...
          property of PayWS Ltd and its licensors. Service is protected by
          ...
          without the prior written consent of PayWS Ltd.
        </p>
        <p>
        ...
        <p>
          ...
          to support@aftawallet.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at support@aftawallet.com or via
        ...
        <p>
          ...
          that are not owned or controlled by PayWS Ltd.
        </p>
        <p>
          PayWS Ltd has no control over, and assumes no responsibility for the
        ...
        <p>
          23. <b>Ads and Pricing</b>
        </p>
        <p>
          Every user can publish an ad, but ads are subject to our strict laws
          on content integrity and therefore no illicit content or nudity or
          bias or pornographic content is supported on the platform. Any such
          person found lacking on that regard shall be suspended and account
          balance confiscated for the damage potentially caused to users who may
        ...
        <p>
          ...
          transaction history but can be requested.
        </p>
        <p>
          24. <b>Acknowledgement</b>
        </p>
        <p>
        ...
        <p>
          ...
          email: <b>support@aftawallet.com</b>.
        </p>
      </div>
    </div>
  );
